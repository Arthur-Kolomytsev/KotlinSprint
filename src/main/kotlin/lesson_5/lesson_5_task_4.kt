...
fun main() {
    ...
    val message =
        "Внимание, пассажир. Моя обязанность, как обычно, незавидная, - приветствовать вас на борту корабля \"Heart of Gold\". " +
                ...
                "Вздыхает ещё глубже... Да, вперед, пожалуйста, вводите свои данные... Что ж, введи, пожалуйста, свое имя пользователя: "
    print(message)
    ...
    if (userName == name) {
        print("Что ж, введи, пожалуйста, свой пароль: ")
        val userPassword = readln()
        if (userPassword == password) {
            val welcomeMessage = "Вздыхает... Ваши данные проверены, и о, чудо, они верны... " +
        ...
        } else println("Что ж, ты ввел неверный пароль...")
